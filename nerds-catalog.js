...
var templateHeaders = document.querySelectorAll(".template-header");
var templateItems = document.querySelectorAll(".templates-item");
var templateFooters = document.querySelectorAll(".template-footer");

console.log(templateHeaders[0]);

 for (let i = 0; i<templateItems.length; i++)
 {
   templateItems[i].addEventListener("mouseover", function(evt){
     evt.preventDefault();
     var header = templateHeaders[i];
     header.classList.add("template-header-hover");
     templateFooters[i].classList.add("template-footer-show");
   })

   templateItems[i].addEventListener("mouseout", function(evt){
     evt.preventDefault();
     var header = templateHeaders[i];
     header.classList.remove("template-header-hover");
     templateFooters[i].classList.remove("template-footer-show");
   })
